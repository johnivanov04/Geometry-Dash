...
/**
 * Allocates memory for an image asset associated with a specific body in the
 * game.
 *
 * @param filepath the filepath to the image file
 * @param body the body that the image asset will be associated with
 * @return a pointer to the newly allocated image asset
 */
asset_t *asset_make_image_with_body(const char *filepath, body_t *body);

/**
 * Retrieves the body associated with an image asset.
 *
 * @param image the image asset from which to retrieve the associated body
 * @return a pointer to the body associated with the image asset
 */
